...
<html>
    ...
    <body>
        ...
        class Delete {
            public int deleteData(String attribute, String value) {
                ...
                try{
                    ...
                    check = statement.executeUpdate("Delete from Registration where "+attribute+" = '"+value+"'");
                }
                catch (Exception e){
                    e.printStackTrace();
                }
        ...
        <% if (request.getParameter("delete") == null) { %>
            <form name="delete" action="deleteRegistration.jsp" method="POST">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><select name="choose">
                                    ...
                                    <option>Email</option>
                                    <option>SecQuestion</option>
                                    <option>SecAnswer</option>
        ...
        if (request.getParameter("delete") != null) { %>
            <br> <a href="deleteRegistration.jsp">delete again</a>
        <% } %>
