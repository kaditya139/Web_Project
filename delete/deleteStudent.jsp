...
<html>
    ...
    <body>
        ...
        class Delete {
            public int deleteData(String attribute, String value) {
                ...
                try{
                    ...
                    check = statement.executeUpdate("Delete from Student where "+attribute+" = '"+value+"'");
                }
                catch (Exception e){
                    e.printStackTrace();
                }
        ...
        <% if (request.getParameter("delete") == null) { %>
            <form name="delete" action="deleteStudent.jsp" method="POST">
        ...
        if (request.getParameter("delete") != null) { %>
            <br> <a href="deleteStudent.jsp">delete again</a>
        <% } %>
