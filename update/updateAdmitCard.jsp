...
<html>
    ...
    <body>
        ...
        class Update {
            public int updateData(String attribute1, String value1, String attribute2, String value2) {
                ...
                try{
                    ...
                    check = statement.executeUpdate("Update AdmitCard set "+attribute2+" = '"+value2+"' "
        ...
        <% if (request.getParameter("update") == null) { %>
            <form name="update" action="updateAdmitCard.jsp" method="POST">
        ...
        if (request.getParameter("update") != null) { %>
            <br> <a href="updateAdmitCard.jsp">update again</a>
        <% } %>
