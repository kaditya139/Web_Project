...
<html>
    ...
    <body>
        ...
        class Update {
            public int updateData(String attribute1, String value1, String attribute2, String value2) {
                ...
                try{
                    ...
                    check = statement.executeUpdate("Update Course set "+attribute2+" = '"+value2+"' "
        ...
        <% if (request.getParameter("update") == null) { %>
            <form name="update" action="updateCourse.jsp" method="POST">
        ...
        if (request.getParameter("update") != null) { %>
            <br> <a href="updateCourse.jsp">update again</a>
        <% } %>
