...
<html>
    ...
    <body>
        ...
        class Update {
            public int updateData(String attribute1, String value1, String attribute2, String value2) {
                ...
                try{
                    ...
                    check = statement.executeUpdate("Update Result set "+attribute2+" = '"+value2+"' "
        ...
        <% if (request.getParameter("update") == null) { %>
            <form name="update" action="updateResult.jsp" method="POST">
        ...
        if (request.getParameter("update") != null) { %>
            <br> <a href="updateResult.jsp">update again</a>
        <% } %>
