...
<html>
    ...
    <body>
        ...
        class Delete {
            public int deleteData(String attribute, String value) {
                ...
                try{
                    ...
                    check = statement.executeUpdate("Delete from Course where "+attribute+" = '"+value+"'");
                }
                catch (Exception e){
                    e.printStackTrace();
                }
        ...
        <% if (request.getParameter("delete") == null) { %>
            <form name="delete" action="deleteCourse.jsp" method="POST">
        ...
        if (request.getParameter("delete") != null) { %>
            <br> <a href="deleteCourse.jsp">delete again</a>
        <% } %>
